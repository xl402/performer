...
linear_attention = [(4, (1, ), ('aecr,aced->acrd', 'acrd,abcr->abcd', 4)),
                    (4, (2, 3), ('aefr,aefd->ard', 'ard,abcr->abcd', 3))]
...
def _test_build_linear_attention_gets_correct_einsum_equations(rank, attn_axes, expected):
